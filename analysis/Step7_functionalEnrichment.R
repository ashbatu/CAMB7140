...
gost.res <- gost(rownames(myModule), organism = "hsapiens", correction_method = "fdr") # finding in all annotations if any are enriched 
...
collection <- list(real = mySig, fake = mySig2) # real enriched signature, fake - should not enriched
