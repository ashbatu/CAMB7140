...
module.assign <- cutree(clustRows, k=2) # 2 clusters of the genes (healthy vs diseased, up vs down, etc)
# each gene has a specified cluster assignment
...
#what do the colors represent in this heatmap? row z-score rather than plotting the data as is (emphasizing comparison between samples; scale = none = emphasis on comparing between genes)
...
write_tsv(moduleData.df,"~/MBMI/CAMB7140/raw_data/module_upRegulated.tsv")
